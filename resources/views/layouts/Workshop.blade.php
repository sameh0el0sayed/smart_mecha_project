...
<head>
  ...
  <!-- Font Awesome Icons -->
  <script src="{{asset('admin_assets/js/fontawesome.js')}}" crossorigin="anonymous"></script>
  <!-- Material Icons -->
  <link href="https://fonts.googleapis.com/icon?family=Material+Icons+Round" rel="stylesheet">
  <!-- CSS Files -->
  <link id="pagestyle" href="{{asset('admin_assets/css/material-dashboard.css?v=3.0.2')}}" rel="stylesheet" />
</head>
...
<body class="g-sidenav-show  bg-gray-200">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
        <span class="fa fa-code text-white"></span>
        <span class="ms-1 font-weight-bold text-white">{{Config::get('app.name')}} - Workshop</span>
      </a>
    </div>
  ...
  <script src="{{asset('admin_assets/js/material-dashboard.min.js?v=3.0.2')}}"></script>
</body>
